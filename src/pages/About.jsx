    ...
    <div className="aboutPage">
      ...
      <div className="aboutme">
        <div className="aboutLogo">
          <img src="./khanmLogo.png" alt="" />
        </div>
        <p>
          Khan Muhammad, 20, professionally known as Khanm, hails from the
          quaint town of Sukkur, Pakistan. <br />
      ...
      <div className="aboutme">
        ...
        <div className="contact-sec">
          <div className="form-container">
            <form
              action="https://formspree.io/f/mgvozwkd"
              target="_blank"
              method="POST"
            >
              <input
