    ...
    <div className="homepage">
      ...
      <div className="hero-content">
        ...
        <p className="description">
          ...
          Singer and songwriter, Khanm captivates a diverse audience with his melodious English and Urdu/Hindi songs.
          Embracing cultural roots and global influences, making him a truly versatile and captivating artist.
        </p>
      ...
      <div className="k-section">
        <div className="newRel">
            ...
            <div className="newRel-R">
              ...
              <div className="newRel-coverArt-container" onMouseMove={handleHover} onMouseLeave={resetHover}><div className="newRel-coverArt"></div></div>
      ...
      <div className="k-section">
        <div className="inSection videos">
          ...
          <div className="content">
            ...
            <iframe className="videoFrame" src="https://www.youtube.com/embed/g618_J-4Sw8?si=d3_f1OzSI2pfbDBN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <div className="inSection liveP">
          ...
          <div className="lp-content">
            <div className="l-cards">
              <hr />
              <LivePCard place='Sukkur IBA' when='NOV 2024' img='../SCA/sibalive.JPG'/>
              <hr />
            </div> 
          </div>
        </div>
