      ...
      <div className="linktree-content">
        <div className="lt-left">
          ...
          <div className="lt-links">
            <Link
              ...
              cl2="feat2"
              imgsrc="./SCA/mkh.jpg"
              link="https://distrokid.com/hyperfollow/khanm/main-kaun-hoon"
            />
            <Link
              title="Youtube"
              icon="Youtube"
              link="https://youtube.com/@khanm"
            />
            <Link
              title="Spotify"
              icon="Spotify"
              link="https://open.spotify.com/artist/5vxQdFbSWYF1Zj99jajZU7?si=m3Wt5LS2T6ikM5qIIaSTKw&nd=1"
            />
            <Link
              title="Instagram"
              icon="Instagram"
              link="https://www.instagram.com/khanmmusic"
            />
            <Link
              title="SoundCloud"
              icon="SoundCloud"
              link="https://soundcloud.com/khan-hp"
            />
            <Link
              title="Apple Music"
              icon="Apple"
              link="https://music.apple.com/us/artist/khanm/1639741390"
            />
          </div>
        </div>
        ...
        <div className="lt-right">
          <iframe
            ...
            src="https://open.spotify.com/embed/artist/5vxQdFbSWYF1Zj99jajZU7?utm_source=generator"
            width="100%"
            height="352"
            allowfullscreen=""
